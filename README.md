...
deschizi aplicația;
pagina INFP se încarcă;
rezolvi CAPTCHA-ul, dacă este solicitat;
permiți notificările, dacă dorești;
configurezi opțiunea pentru sunete;
lași aplicația să ruleze.
...
dacă pagina INFP este încărcată;
dacă ai permis notificările atunci când site-ul le-a solicitat;
dacă notificările Windows sunt activate;
dacă ai conexiune la internet;
dacă aplicația încă rulează în system tray.
